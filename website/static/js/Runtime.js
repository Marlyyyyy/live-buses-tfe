...
var MapModule;
(function (MapModule) {
    var ajaxVehiclesPath;
    var ajaxRouteAndStopsPath;
    var ajaxAddFavouritePath;
    var ajaxRmvFavouritePath;
    var map = null;
    ...
    function registerEventListeners() {
        ...
        var serviceButtons = $(".service-box");
        ...
        postToServer(ajaxVehiclesPath, { services: [selectedService] }, function (data) {
            ...
            for (var i = 0; i < vehicles.length; i++) {
                ...
                if (vehicles[i].destination == dest)
                    ...
                    dIcon = "busReverse";
                var position = { lat: vehicles[i].latitude, lng: vehicles[i].longitude };
                var options = {
                    icon: dIcon,
                    infoWindowContent: "<div class='map-info-window'>" + "Service: " + vehicles[i].service_name + " | " + "Destination: " + vehicles[i].destination + " | " + "Speed: " + vehicles[i].speed + " mph </div>"
                };
...
(function (ErrorModule) {
    ...
    ErrorModule.registerContainer = registerContainer;
    ...
    ErrorModule.displayErrors = displayErrors;
    ...
    ErrorModule.hideErrors = hideErrors;
...
(function (LoadingModule) {
    ...
    LoadingModule.showLoadingBar = showLoadingBar;
    function hideLoadingBar() {
        $(loadingContainer).fadeOut(150);
    }
    LoadingModule.hideLoadingBar = hideLoadingBar;
